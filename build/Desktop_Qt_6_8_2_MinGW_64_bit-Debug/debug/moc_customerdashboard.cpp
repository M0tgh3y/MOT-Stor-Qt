...
static constexpr auto qt_meta_stringdata_ZN17customerdashboardE = QtMocHelpers::stringData(
    "customerdashboard",
    "on_back_clicked",
    "",
    "on_showPro_clicked"
...
Q_CONSTINIT static const uint qt_meta_data_ZN17customerdashboardE[] = {
...
Q_CONSTINIT const QMetaObject customerdashboard::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17customerdashboardE.offsetsAndSizes,
    qt_meta_data_ZN17customerdashboardE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17customerdashboardE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<customerdashboard, std::true_type>,
...
void customerdashboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_showPro_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *customerdashboard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17customerdashboardE.stringdata0))
