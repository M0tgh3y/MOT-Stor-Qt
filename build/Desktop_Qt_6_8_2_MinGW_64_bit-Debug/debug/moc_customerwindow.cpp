...
static constexpr auto qt_meta_stringdata_ZN14CustomerWindowE = QtMocHelpers::stringData(
    "CustomerWindow",
    "on_ok_clicked",
    "",
    "on_back_clicked",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14CustomerWindowE[] = {
...
Q_CONSTINIT const QMetaObject CustomerWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14CustomerWindowE.offsetsAndSizes,
    qt_meta_data_ZN14CustomerWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14CustomerWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *CustomerWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14CustomerWindowE.stringdata0))
