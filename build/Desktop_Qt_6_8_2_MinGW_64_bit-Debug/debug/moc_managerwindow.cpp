...
static constexpr auto qt_meta_stringdata_ZN13ManagerWindowE = QtMocHelpers::stringData(
    "ManagerWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13ManagerWindowE[] = {
...
Q_CONSTINIT const QMetaObject ManagerWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13ManagerWindowE.offsetsAndSizes,
    qt_meta_data_ZN13ManagerWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13ManagerWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *ManagerWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13ManagerWindowE.stringdata0))
